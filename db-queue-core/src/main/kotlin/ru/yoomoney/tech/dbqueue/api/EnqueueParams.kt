...
class EnqueueParams<PayloadT> {
     ...
     */
    fun withPayload(payload: PayloadT?): EnqueueParams<PayloadT> {
     ...
     */
    fun withExecutionDelay(executionDelay: Duration): EnqueueParams<PayloadT> {
     ...
     */
    fun withExtData(columnName: String, value: String?): EnqueueParams<PayloadT> {
     ...
     */
    fun withExtData(extData: Map<String, String?>): EnqueueParams<PayloadT> {
    ...
    companion object {
        ...
        fun <PayloadBuilderT> create(payload: PayloadBuilderT): EnqueueParams<PayloadBuilderT> {
            Objects.requireNonNull(payload)
            return EnqueueParams<PayloadBuilderT>().withPayload(payload)
        }
    }
}
