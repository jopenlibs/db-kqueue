...
class CompositeTaskLifecycleListenerTest {
    ...
    fun should_handle_picked_in_order() {
        ...
        val firstListener = StubTaskLifecycleListener("1", events)
        val secondListener = StubTaskLifecycleListener("2", events)
    ...
    fun should_handle_executed_in_order() {
        ...
        compositeListener.executed(SHARD_ID, LOCATION, TASK_RECORD, finish(), 42L)
